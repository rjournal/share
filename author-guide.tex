...
Texinfo\marginpar{\url{http://www.gnu.org/software/texinfo/}} (but note that the \LaTeX{} special
...
references in {\sc Bib}\TeX{} format.\marginpar{We use the \pkg{natbib}
