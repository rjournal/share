...
Texinfo\marginnote{\url{http://www.gnu.org/software/texinfo/}} (but note that the \LaTeX{} special
...
references in {\sc Bib}\TeX{} format\marginnote{We use the \pkg{natbib}
...
%  headers. Use 4cm marginpar. Support for wide (widefig) and margin figures (marginfig).}
