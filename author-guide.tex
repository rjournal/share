...
Please send submissions to the Editor-in-Chief.
...
Running \code{pdflatex} and \code{bibtex} on \file{RJwrapper.tex} a couple of times
...
\file{RJwrapper.pdf} and all necessary figure files.
